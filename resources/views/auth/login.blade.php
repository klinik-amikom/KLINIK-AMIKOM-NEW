...
<body class="h-full bg-gray-50 dark:bg-gray-900 transition-colors duration-300 font-sans">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            <img src="https://jecconsultant.co.id/wp-content/uploads/2020/02/amikom-1.jpg" alt="University Amikom Yogyakarta" class="absolute inset-0 w-full h-full object-cover animate-fade-in" />
            <!-- Gradient Overlay -->
            ...
            <div class="relative z-10 flex flex-col justify-end p-8 lg:p-12 text-white">
                ...
                <div class="space-y-6">
                    ...
                    <h2 class="text-3xl lg:text-4xl font-bold leading-tight text-shadow">
                        Klinik Amikom
                        <span class="text-primary-400 bg-gradient-to-r from-accent-400 to-purple-400 bg-clip-text text-transparent">
                            Yogyakarta
                        </span>
                        Website
                    </h2>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center group">
                            ...
                            <span class="text-white/90 group-hover:text-white transition-colors duration-200">Poli Umum</span>
                        </div>
                        <div class="flex items-center group">
                            <i class="fas fa-check-circle text-accent-400 mr-3 transform group-hover:scale-110 transition-transform duration-200"></i>
                            <span class="text-white/90 group-hover:text-white transition-colors duration-200">Poli Gigi</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="login-container" class="w-full lg:w-1/2 flex flex-col justify-center bg-white dark:bg-gray-900 transition-colors duration-300">
            <div class="px-6 sm:px-8 py-12 max-w-md mx-auto w-full animate-slide-in-right">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6" novalidate>
                    ...
                    <!-- Email Field -->
                    <div class="space-y-2">
                        <label for="username" class="block text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">
                            <i class="fas fa-envelope mr-2 text-primary-500 dark:text-accent-400"></i>
                            Username
                        </label>
                        <input id="username" name="username" type="text" value="{{ old('username') }}" required class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-primary-500 dark:focus:border-accent-400 focus:ring-2 focus:ring-primary-500/20 dark:focus:ring-accent-400/20 focus:outline-none transition-all duration-200 transform focus:-translate-y-0.5 hover:border-gray-400 dark:hover:border-gray-500 @error('username') border-red-500 dark:border-red-400 @enderror" placeholder="Enter your username address" autocomplete="username" />
                        @error('username')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input id="password" name="password" type="password" value="" required class="w-full px-4 py-3 pr-12 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-primary-500 dark:focus:border-accent-400 focus:ring-2 focus:ring-primary-500/20 dark:focus:ring-accent-400/20 focus:outline-none transition-all duration-200 transform focus:-translate-y-0.5 hover:border-gray-400 dark:hover:border-gray-500 @error('password') border-red-500 dark:border-red-400 @enderror" placeholder="Enter your password" autocomplete="current-password" />
    ...
    <div id="loading-overlay" class="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 hidden backdrop-blur-sm transition-all duration-300">
        <div id="loading-box" class="bg-white dark:bg-gray-800 rounded-xl p-6 flex items-center space-x-4 shadow-2xl border border-gray-200 dark:border-gray-700 transform animate-pulse">
            ...
            <span id="loading-text" class="text-gray-900 dark:text-white font-medium">Memproses masuk ke sistem...</span>
        </div>
    </div>
