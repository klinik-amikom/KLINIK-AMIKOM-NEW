...
@if(session('error'))
<div class="alert-auto-hide mb-4 bg-red-100 border border-red-400 tex
t-red-700 px-4 py-3 rounded relative dark:bg-red-900/30 dark:border-red-600 dark:text-red-300" role="alert">
...
<div class="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-6 sm:mb-8">
    <div>
        ...
        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">
            Kelola data merchant dan admin dalam sistem
        </p>
    </div>
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-8">
                            <div class="text-gray-500 dark:text-gray-400">
                                ...
                                <p class="text-lg font-medium">Data admin tidak tersedia</p>
    ...
    <div id="card-view" class="hidden">
        ...
        @forelse ($users as $user)
            ...
            <div class="text-center py-8">
                <div class="text-gray-500 dark:text-gray-400">
                    <i class="fas fa-users text-4xl mb-4"></i>
                    <h4 class="text-lg font-medium">Data Admin Tidak Tersedia</h4>
                    <p class="text-sm">Belum ada admin yang terdaftar dalam sistem</p>
                </div>
            </div>
            @endforelse
...
function updateUser() {
    ...
    // Set form action and method
    form.action = `/admin/admin/${userId}`;
    form.method = 'POST';
...
function deleteUser(userId, userName) {
    ...
    if (!confirm(`Apakah Anda yakin ingin menghapus Admin "${userName}"? Data yang dihapus tidak dapat dikembalikan!`)) {
        return;
    }
